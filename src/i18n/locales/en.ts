...
export const en: Resource = {
  ...
  locate: {
    ...
    quickLabel: 'Pick a common landmark (tap)',
    estimatedTitle: 'Estimated position',
    estimatedNear: 'Near {{name}}',
    startHere: 'Start guidance from here',
    fixedNote:
      'Your position stays fixed during guidance (no tracking). If it drifts, tap "I\'m lost" to re-estimate.',
    candidatesTitle: 'Other candidates',
